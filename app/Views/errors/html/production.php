...
<head>
	...
	<title>System Error, Try Again Later</title>
</head>
...
<body>
	<div class="container my-5">
		<div class="card">
			<div class="card-body">
				<h1 align="center">System Error, Try Again Later</h1>
				<hr>
				<center>
					<img id="404" src="<?= base_url('assets/img/gambar/error-white.png') ?>" width="250px">
				</center>
				<hr>
			</div>
			<center>
	...
	<script>
		...
		if (localStorage.getItem('tema') === 'dark') {
			...
			document.getElementById('404').setAttribute('src', `<?= base_url('assets/img/gambar/error-black.png') ?>`);
		} else {
